...
public class VehicleController {
    ...
    @CrossOrigin(origins = "*", maxAge = 3600)
    @RequestMapping(value = "/ownerByNIC/{nic}", method = RequestMethod.GET, produces = {"application/json"})
    Owner getOwnerByNIC(@PathVariable("nic") String nic) throws Exception {
        return ownerService.getOwnerByNic(nic);
    }
