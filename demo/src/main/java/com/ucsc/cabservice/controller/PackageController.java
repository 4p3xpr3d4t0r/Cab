...
public class PackageController {
    ...
    @CrossOrigin(origins = "*", maxAge = 3600)
    @RequestMapping(value = "/packageByName/{name}", method = RequestMethod.GET, produces = {"application/json"})
    public Package getPackageByName(@PathVariable("name") String id) throws Exception {
        return packagesService.getPackageByName(id);
    }
}
